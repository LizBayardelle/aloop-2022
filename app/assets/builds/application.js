...
(0, import_jquery.default)(function() {
  (0, import_jquery.default)(document).tooltip();
  (0, import_jquery.default)("#accordion").accordion();
  (0, import_jquery.default)("#dialog").dialog();
  (0, import_jquery.default)("#tabs").tabs();
  (0, import_jquery.default)(document).tooltip({
    content: function() {
      return (0, import_jquery.default)(this).prop("title");
    }
  });
});
console.log(`i am here!!`);
setTimeout(function() {
  (0, import_jquery.default)(".alert").fadeOut("fast");
}, 5e3);
