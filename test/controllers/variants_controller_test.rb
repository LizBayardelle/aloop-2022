...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { component_id: @variant.component_id, description: @variant.description, name: @variant.name, price_adjustment: @variant.price_adjustment } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { component_id: @variant.component_id, description: @variant.description, name: @variant.name, price_adjustment: @variant.price_adjustment } }
